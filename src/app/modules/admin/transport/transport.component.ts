...
export class TransportComponent implements OnInit {
  ...
  getData() {
    let url = 'admin/getTransportManagerByBusinessId';
    this.callGrid = false;
    this.data.url = url;
    ...
    this.data.columns = ['profilePic','firstName', 'lastName','contactNumber','email','address','gender','totalSalary','yearJoined','employeeId','designation','rfidTag','qualification','experience','yearOfJoin','password','confirmPassword','userName','dob'];
    this.fields = [
      {
        field: 'profilePic',
        label: 'Picture',
